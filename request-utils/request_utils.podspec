Pod::Spec.new do |spec|
    ...
    spec.vendored_frameworks      = 'build/cocoapods/framework/request-utils.framework'
    spec.libraries                = 'c++'
    spec.ios.deployment_target = '14.1'
                
                
    spec.pod_target_xcconfig = {
        'KOTLIN_PROJECT_PATH' => ':request-utils',
        'PRODUCT_MODULE_NAME' => 'request-utils',
    }
                
    spec.script_phases = [
        {
            :name => 'Build request_utils',
